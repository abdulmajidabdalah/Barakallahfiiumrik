...
const config = {
  name: "Sok", // actual name of the recipient (Mandatory)

  nickname: "Lamia Hanifa", // nickname(optional)
...
CTAtext.innerHTML = "Tap Lampunya biar terang !";
...
button.addEventListener("click", function () {
  if (button.classList.contains("switch")) {
    ...
    light.play();
    transition(darkroom);
    CTAtext.innerHTML = "Tap Pintunya";
    setTimeout(function () {
    ...
    door.play();
    transition(hallway);
    CTAtext.innerHTML = "Coba deh Tap kadonya !";
    setTimeout(function () {
    ...
    document.querySelector(".HBD").textContent = "Barakallah fii umrik";
